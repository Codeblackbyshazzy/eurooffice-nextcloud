OC.L10N.register(
    ...
    "Save" : "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Contenido Mixto Activo no está permitido. Se requiere la dirección HTTPS para Euro-Office.",
    ...
    "Connect to demo Euro-Office server" : "Conectarse al servidor de Euro-Office de demostración",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "El período de prueba de 30 días ha terminado, ya no puedes conectarte al servidor de Euro-Office de demostración",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Estás usando el servidor de Euro-Office de demostración. Por favor, no almacenes tus datos confidenciales aquí.",
    ...
    "group": "grupo",
    "Advanced": "Avanzado",
    "Provide advanced document permissions using Euro-Office": "Proporcione permisos avanzados para los documentos utilizando Euro-Office",
    ...
    "Welcome to Euro-Office!": "¡Bienvenido(a) a Euro-Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Edite y colabore en documentos de texto, hojas de cálculo, presentaciones y archivos PDF dentro de Nextcloud usando Euro-Office.",
    ...
    "To ensure the security of important parameters in Euro-Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantizar la seguridad de los parámetros importantes en las solicitudes de Euro-Office, establezca una clave secreta en la página de configuración. Para obtener más información, <a href=\"{url}\" target=\"_blank\">haga clic aquí</a>.",
    "Info": "Información",
    "Open": "Abrir",
