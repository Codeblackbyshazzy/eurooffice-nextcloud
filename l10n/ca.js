OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Ubicació de l'Euro-Office especifica la direcció del servidor amb els serveis de documents instal·lats. Si us plau, canviï '<documentserver>' per a la direcció de servidor en la línia inferior.",
    "Euro-Office address": "Direcció d'Euro-Office",
    "Advanced server settings": "Ajustos de servidor avançats",
    "Euro-Office address for internal requests from the server": "Direcció d'Euro-Office per a sol·licituds internes del servidor",
    "Server address for internal requests from Euro-Office": "Direcció de servidor per a sol·licituds internes de l'Euro-Office",
    ...
    "Save": "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required.": "Contingut Mixt Actiu no està permès. Es requereix la direcció HTTPS per a Euro-Office.",
    ...
    "Connect to demo Euro-Office server": "Connectar-se al servidor de Euro-Office de demostració",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server.": "El període de prova de 30 dies ha acabat, ja no pots connectar-te al servidor d'Euro-Office de demostració",
    "You are using public demo Euro-Office server. Please do not store private sensitive data.": "Estàs fent servir el servidor d'Euro-Office de demostració. Si us plau, no emmagatzemis les teves dades confidencials aquí.",
    ...
    "group": "agrupa",
    "Advanced": "Avançat",
    "Provide advanced document permissions using Euro-Office": "Proporcioneu permisos avançats de documents mitjançant Euro-Office",
