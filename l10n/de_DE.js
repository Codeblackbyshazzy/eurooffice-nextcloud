OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Officestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Bitte ändern Sie '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    "Euro-Office address" : "Die Adresse von Euro-Office",
    "Advanced server settings" : "Erweiterte Servereinstellungen",
    "Euro-Office address for internal requests from the server" : "Die Adresse von Euro-Office für interne Anforderungen vom Server",
    "Server address for internal requests from Euro-Office" : "Serveradresse für interne Anforderungen vom Euro-Office",
    ...
    "Save" : "Speichern",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Mixed Active Content ist nicht möglich. HTTPS-Adresse für Euro-Office ist erforderlich.",
    ...
    "Connect to demo Euro-Office server": "Verbindung zu Demo Euro-Office Server herstellen",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server.": "Der 30-tägige Testzeitraum ist abgelaufen. Sie können keine Verbindung mehr zu Demo Euro-Office Server herstellen.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data.": "Sie verwenden den öffentlichen Demo Euro-Office Server. Bitte benutzen Sie ihn nicht zum Speichern von Ihren privaten sensiblen Daten.",
    ...
    "group": "gruppe",
    "Advanced": "Erweitert",
    "Provide advanced document permissions using Euro-Office": "Erweiterte Zugriffsrechte in Euro-Office vergeben",
    ...
    "Welcome to Euro-Office!": "Willkommen bei Euro-Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Mit Euro-Office können Sie Textdokumente, Tabellenkalkulationen, Präsentationen und PDFs innerhalb von Nextcloud gemeinsam bearbeiten.",
