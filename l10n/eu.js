OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office-en kokapenak dokumentu zerbitzuak instalatuta daude zerbitzariaren helbidea zehazten du. Mesedez, aldatu '<documentserver>' zerbitzariaren helbideagatik beheko lerroan.",
    "Euro-Office address" : "Euro-Office-en helbidea",
    "Advanced server settings" : "Zerbitzariaren ezarpen aurreratuak",
    "Euro-Office address for internal requests from the server" : "Euro-Office-en helbidea zerbitzariaren barneko eskaeretarako",
    "Server address for internal requests from Euro-Office" : "Zerbitzariaren helbidea Euro-Office-en barneko eskaeretarako",
    ...
    "Save" : "Gorde",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Eduki Nahasi Aktiboa ez da onartzen. Euro-Office-erako HTTPS helbidea behar da.",
    ...
    "Connect to demo Euro-Office server" : "Konektatu Euro-Office demo zerbitzarira",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30 eguneko probaldia amaitu da, ezin zara Euro-Office demo zerbitzarira gehiago konektatu",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Euro-Office demo zerbitzari publikoa erabiltzen ari zara. Mesedez, ez gorde zure datu konfidentzialak hemen.",
    ...
    "group": "taldea",
    "Advanced": "Aurreratua",
    "Provide advanced document permissions using Euro-Office": "Eman baimen aurreratuak dokumentuei Euro-Office erabiliz",
