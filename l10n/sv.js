OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office plats specificerar adressen till servern där Euro-Office är installerad. Ändra '<dokumentserver>' till serverns adress i nedanstående rad.",
    "Euro-Office address" : "Adress till Euro-Office",
    "Advanced server settings" : "Avancerade serverinställningar",
    "Euro-Office address for internal requests from the server" : "Adress till Euro-Office för interna förfragningar från servern",
    "Server address for internal requests from Euro-Office" : "Serveradress för interna förfrågningar från Euro-Office",
    ...
    "Save" : "Spara",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Blandat aktivt innehåll är inte tillåtet. HTTPS-adress till Euro-Office krävs.",
    ...
    "Connect to demo Euro-Office server" : "Anslut till demo Euro-Officeserver",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "När 30-dagars testperioden är över, kan du inte längre ansluta till demo Euro-Officeserver.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Du använder en offentlig demo Euro-Officeserver. Lagra inte privat känslig information.",
    ...
    "group": "grupp",
    "Advanced": "Avancerad",
    "Provide advanced document permissions using Euro-Office": "Tillhandahåll avancerade dokumentbehörigheter med Euro-Office",
