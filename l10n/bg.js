OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Адреса на Euro-Office определя адреса на сървъра с инсталирани услуги за документи. Моля, променете '<documentserver>' адреса на сървъра в долния ред.",
    "Euro-Office address" : "Адрес на Euro-Office",
    "Advanced server settings" : "Допълнителни настройки на сървъра",
    "Euro-Office address for internal requests from the server" : "Адрес на Euro-Office за вътрешни заявки към сървъра",
    "Server address for internal requests from Euro-Office" : "Адрес на сървъра за вътрешни заявки на Euro-Office",
    ...
    "Save" : "Запази",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Смесеното активно съдържание е недопустимо. За Euro-Office е необходимо използването на HTTPS-адрес.",
    ...
    "Connect to demo Euro-Office server" : "Свързване с демо Euro-Office сървър",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30-дневният тестов период приключи, вече не можете да се свържете с демо Euro-Office сървър.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Използвате обществения демо Euro-Office сървър. Моля, не съхранявайте чувствителни частни данни на него.",
    ...
    "Provide advanced document permissions using Euro-Office": "Предоставете нови разрешения за документи с помощта на Euro-Office",
