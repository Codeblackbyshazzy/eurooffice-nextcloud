OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Location specifica l'indirizzo del server con i servizi documenti installati. Modifica il '<documentserver>' con l'indirizzo del server nella riga sottostante.",
    "Euro-Office address" : "Indirizzo di Euro-Office",
    "Advanced server settings" : "Impostazioni avanzate del server",
    "Euro-Office address for internal requests from the server" : "Indirizzo di Euro-Office per le richieste interne del server",
    "Server address for internal requests from Euro-Office" : "Indirizzo del server per le richieste interne da Euro-Office",
    ...
    "Save" : "Salva",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Il contenuto attivo misto non è consentito. È richiesto l'indirizzo HTTPS per Euro-Office.",
    ...
    "Connect to demo Euro-Office server" : "Collegati alla versione demo di Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "Il periodo di prova di 30 giorni è terminato; non è più possibile connettersi alla versione demo di Euro-Office.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Stai utilizzando la versione demo pubblica di Euro-Office. Non memorizzare dati sensibili privati.",
    ...
    "group": "gruppo",
    "Advanced": "Avanzate",
    "Provide advanced document permissions using Euro-Office": "Fornisci autorizzazioni avanzate per i documenti utilizzando Euro-Office",
    ...
    "Welcome to Euro-Office!": "Benvenuto in Euro-Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Modifica e collabora su documenti di testo, fogli di calcolo, presentazioni e PDF all'interno di Nextcloud usando Euro-Office.",
    ...
    "To ensure the security of important parameters in Euro-Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Per garantire la sicurezza dei parametri importanti nelle richieste di Euro-Office, imposta una Chiave Segreta nella pagina delle Impostazioni. Per saperne di più, <a href=\"{url}\" target=\"_blank\">clicca qui</a>.",
    "Info": "Info",
    "Open": "Apri",
