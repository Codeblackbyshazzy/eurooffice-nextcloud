OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Lokacja Euro-Office to adres serwera na którym Usługi Dokumentów są zainstalowe. Proszę zmienić '<documentserver>' na adres poniżej.",
    "Euro-Office address" : "Adres Euro-Office",
    "Advanced server settings" : "Zaawansowane ustawienia serwera",
    "Euro-Office address for internal requests from the server" : "Adres Euro-Office dla zapytań wewnętrznych",
    "Server address for internal requests from Euro-Office" : "Adres serwera dla zapytań wewnętrznych z Euro-Office",
    ...
    "Save" : "Zapisz",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Aktywna Zawartość Mieszana nie jest dozwolona. Adres HTTPS jest wymagany dla Euro-Office.",
    ...
    "Connect to demo Euro-Office server" : "Połącz się z serwerem demo Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "Upłyneło 30 dni, nie możesz się już łączyć z serwerem demo.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Używasz publicznego serwera demo. Nie przechowuj tu prywatnych danych.",
    ...
    "Provide advanced document permissions using Euro-Office": "Udziel zaawansowanych uprawnień do edycji dokumentów w Euro-Office",
    ...
    "Welcome to Euro-Office!": "Witaj w Euro-Office!",
