OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Euro-Office Location geeft het adres op van de server waarop de documentdiensten geïnstalleerd zijn. Verander de '<documenterver>' voor het serveradres in de onderstaande regel.",
    "Euro-Office address": "Euro-Office adres",
    "Advanced server settings": "Geavanceerde serverinstellingen",
    "Euro-Office address for internal requests from the server": "Adres van de Euro-Office voor interne verzoeken van de server",
    "Server address for internal requests from Euro-Office": "Serveradres voor interne verzoeken van de Euro-Office",
    ...
    "Save": "Opslaan",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required.": "Gemende Actieve Inhoud is niet toegestaan. HTTPS-adres voor Euro-Office is vereist.",
    ...
    "Connect to demo Euro-Office server": "Verbinden met de demo Euro-Office server",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server.": "De 30-dagen proefperiode is voorbij, u kunt niet langer verbinding maken met demo Euro-Office server.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data.": "U gebruikt de openbare demo Euro-Office server. Sla geen vertrouwelijke gegevens op.",
    ...
    "Provide advanced document permissions using Euro-Office": "Geavanceerde documentrechten geven met Euro-Office",
    ...
    "Welcome to Euro-Office!": "Welkom bij Euro-Office!",
