OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "L'emplacement du Euro-Office désigne l'adresse du serveur sur lequel est installé le service de document. Veuillez modifier le '<documentserver>' avec l'adresse du serveur de service de document dans la ligne ci-dessous",
    "Euro-Office address" : "Adresse du Euro-Office",
    "Advanced server settings" : "Paramètres avancés du serveur",
    "Euro-Office address for internal requests from the server" : "Adresse du Euro-Office pour les demandes internes du serveur",
    "Server address for internal requests from Euro-Office" : "Adresse du serveur pour les demandes internes du Euro-Office",
    ...
    "Save" : "Enregistrer",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Le contenu mixte actif n'est pas autorisé. Une adresse HTTPS pour le Euro-Office est requise",
    ...
    "Connect to demo Euro-Office server" : "Se connecter à la version démo de Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "La période d'essai de 30 jours est expirée, vous n'êtes plus en mesure de vous connecter à la version démo de Euro-Office.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Vous utilisez la version démo de Euro-Office, proposée à des fins de tests. Veuillez ne pas stocker vos données confidentielles.",
    ...
    "group": "groupe",
    "Advanced": "Avancé",
    "Provide advanced document permissions using Euro-Office": "Fournir des autorisations avancées pour les documents en utilisant Euro-Office",
    ...
    "Welcome to Euro-Office!": "Bienvenue dans Euro-Office !",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Modifiez et collaborez sur des documents texte, des feuilles de calcul, des présentations et des fichiers PDF dans Nextcloud à l'aide de Euro-Office.",
