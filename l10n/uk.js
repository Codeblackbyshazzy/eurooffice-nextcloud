OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Розташування Euro-Office визначає адресу сервера зі встановленими службами документів. Будь ласка, замініть '<documentserver>' на дійсну адресу сервера.",
    "Euro-Office address" : "Адреса Euro-Office",
    "Advanced server settings" : "Додаткові налаштування сервера",
    "Euro-Office address for internal requests from the server" : "Адреса Euro-Office для внутрішніх запитів сервера",
    "Server address for internal requests from Euro-Office" : "Адреса сервера для внутрішніх запитів Euro-Office",
    ...
    "Save" : "Зберегти",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Змішаний активний вміст заборонено. Для користування Euro-Office потрібно використовувати безпечне з'єднання HTTPS.",
    ...
    "Connect to demo Euro-Office server" : "З'єднатися з демонстраційним сервером Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "Тестовий 30-денний період вичерпано. Ви більше не маєте змоги з'єднуватися з демонстраційним сервером Euro-Office",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Ви використовуєте ПУБЛІЧНИЙ демонстраційний сервер Euro-Office. Будь ласка, не зберігайте ваші приватні дані.",
    ...
    "group": "група",
    "Advanced": "Додатково",
    "Provide advanced document permissions using Euro-Office": "Увімкнути розширені права доступу до документів у Euro-Office",
