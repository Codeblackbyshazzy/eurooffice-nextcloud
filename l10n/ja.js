OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Docsアドレスにはドキュメントサービスがインストールされているサーバーのアドレスを指定します。以下の行の'<documentserver>'をサーバーアドレスに変更してください。",
    "Euro-Office address" : "Euro-Office アドレス",
    "Advanced server settings": "サーバー詳細設定",
    "Euro-Office address for internal requests from the server": "サーバーから内部リクエストに利用されるEuro-Office アドレス",
    "Server address for internal requests from Euro-Office": "Euro-Officeから内部リクエストに利用されるサーバーアドレス",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "アクティブコンテンツの混在は許可されていません。Euro-OfficeにはHTTPSアドレスが必要です",
    ...
    "Connect to demo Euro-Office server" : "Euro-Officeのデモサーバーに接続する",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30日間のテスト期間が終了したら、Euro-Office デモサーバーには繋がらなくなります。",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "パブリック Euro-Office サーバーを使っているので、プライベートな機密データを利用しないようにしてください。",
    ...
    "group": "グループ",
    "Advanced": "詳細",
    "Provide advanced document permissions using Euro-Office": "Euro-Officeを利用した高度なドキュメント権限の提供",
    ...
    "Welcome to Euro-Office!": "Euro-Officeへようこそ！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Euro-Officeを使用して、Nextcloud内でテキストドキュメント、スプレッドシート、プレゼンテーション、PDFを編集・共同作業できます。",
    "Learn more": "詳細を見る",
    ...
    "To ensure the security of important parameters in Euro-Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Euro-Officeリクエストの重要なパラメータのセキュリティを確保するため、設定ページでシークレットキーを設定してください。詳細については、<a href=\"{url}\" target=\"_blank\">こちらをクリック</a>してください。",
    "Info": "情報",
    "Open": "開く",
