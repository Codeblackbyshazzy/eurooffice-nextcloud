OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Расположение Euro-Office определяет адрес сервера с установлеными службами документов. Пожалуйста, замените '<documentserver>' в поле ниже на адрес сервера.",
    "Euro-Office address" : "Адрес Euro-Office",
    "Advanced server settings" : "Дополнительные настройки сервера",
    "Euro-Office address for internal requests from the server" : "Адрес Euro-Office для внутренних запросов сервера",
    "Server address for internal requests from Euro-Office" : "Адрес сервера для внутренних запросов Euro-Office",
    ...
    "Save" : "Сохранить",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Смешанное активное содержимое запрещено. Для Euro-Office необходимо использовать HTTPS-адрес.",
    ...
    "Connect to demo Euro-Office server" : "Подключиться к демонстрационному серверу Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30-дневный тестовый период закончен, вы больше не можете подключаться к демонстрационному серверу Euro-Office",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Вы используете публичный демонстрационный сервер Euro-Office. Пожалуйста, не храните конфиденциальные данные.",
    ...
    "Provide advanced document permissions using Euro-Office": "Предоставление расширенных прав доступа к документам с помощью Euro-Office",
    ...
    "Welcome to Euro-Office!": "Добро пожаловать в Euro-Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Редактируйте текстовые документы, электронные таблицы, презентации и PDF-файлы, а также работайте над ними вместе с другими пользователями в Nextcloud, используя Euro-Office.",
