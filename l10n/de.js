OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Officestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Ändere bitte '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "Der 30-tägige Testzeitraum ist abgelaufen. Du kannst keine Verbindung mehr zu Demo Euro-Office Server herstellen.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Du verwendest den öffentlichen Demo Euro-Office Server. Bitte benutze ihn nicht zum Speichern von Deinen privaten sensiblen Daten.",
