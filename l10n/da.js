OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Lokation angiver adressen på serveren med dokumenttjenesterne installeret. Skift venligst '<dokumentserver>' for serveradressen i linjen nedenfor.",
    "Euro-Office address" : "Euro-Office-adresse",
    "Advanced server settings" : "Avancerede serverindstillinger",
    "Euro-Office address for internal requests from the server" : "Euro-Office-adresse for interne anmodninger fra serveren",
    "Server address for internal requests from Euro-Office" : "Serveradresse for interne anmodninger fra Euro-Office",
    ...
    "Save" : "Gem",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Blandet aktivt indhold er ikke tilladt. HTTPS-adresse for Euro-Office er påkrævet.",
    ...
    "Connect to demo Euro-Office server" : "Opret forbindelse til demo Euro-Office-server",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30-dages testperioden er forbi, du kan ikke længere oprette forbindelse til demo Euro-Office-server.",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Du bruger den offentlige demo Euro-Office-server. Gem venligst ikke private følsomme data.",
    ...
    "group": "gruppe",
    "Advanced": "Avanceret",
    "Provide advanced document permissions using Euro-Office": "Giv avancerede dokumenttilladelser ved brug af Euro-Office",
