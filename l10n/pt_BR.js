OC.L10N.register(
    ...
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "O Endereço do Euro-Office especifica o servidor onde o serviço de documentos está instalado.\nPor favor mude '<documentserver>' para o endereço do servidor na linha abaixo.",
    "Euro-Office address" : "Endereço do Euro-Office",
    "Advanced server settings" : "Configurações avançadas do servidor",
    "Euro-Office address for internal requests from the server" : "Endereço do Euro-Office para pedidos internos do servidor",
    "Server address for internal requests from Euro-Office" : "Endereço do servidor para pedidos internos do Euro-Office",
    ...
    "Save" : "Salvar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "Conteúdo Misto não é permitido. É necessário um endereço HTTPS para o Euro-Office.",
    ...
    "Connect to demo Euro-Office server" : "Conectar ao Servidor de demonstração do Euro-Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "O período de teste de 30 dias acabou, você não pode mais se conectar ao Servidor de demonstração do Euro-Office",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "Você está usando o Servidor de demonstração pública. Não armazene dados confidenciais.",
    ...
    "group": "grupo",
    "Advanced": "Avançado",
    "Provide advanced document permissions using Euro-Office": "Forneça permissões avançadas de documentos usando o Euro-Office",
    ...
    "Welcome to Euro-Office!": "Bem-vindo ao Euro-Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "Edite e colabore em documentos de texto, planilhas, apresentações e PDFs no Nextcloud usando o Euro-Office.",
