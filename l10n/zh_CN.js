OC.L10N.register(
    ...
    "Documentation" : "文档集",
    "Euro-Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office 位置指定了安装了文档服务的服务器的地址，请将'<documentserver>'改为下面一行中的服务器地址。",
    "Euro-Office address" : "Euro-Office地址",
    "Advanced server settings" : "更多设置",
    "Euro-Office address for internal requests from the server" : "服务器内部请求 Euro-Office 的地址",
    "Server address for internal requests from Euro-Office" : "Euro-Office 内部请求服务器的地址",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office is required." : "不允许混合活动内容，请使用HTTPS连接Euro-Office。",
    ...
    "Connect to demo Euro-Office server" : "连接到 Euro-Office 演示服务器",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office server." : "30天试用期已结束，无法连接Euro-Office 演示服务器。",
    "You are using public demo Euro-Office server. Please do not store private sensitive data." : "您正在使用 Euro-Office 公开的演示服务器，请勿存储隐私数据。",
    ...
    "group": "分组",
    "Advanced": "进阶",
    "Provide advanced document permissions using Euro-Office": "使用Euro-Office 提供高级文档权限",
    "Enable plugins": "启用插件",
    ...
    "Welcome to Euro-Office!": "欢迎使用 Euro-Office 文档！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office.": "在 Nextcloud 中使用 Euro-Office 文档编辑和协作处理文本文档、电子表格、演示文稿和 PDF 文件。",
    "Learn more": "了解更多",
    ...
    "To ensure the security of important parameters in Euro-Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "为确保 Euro-Office 文档请求中重要参数的安全，请在“设置”页面设置密钥。要了解更多信息，请<a href=\"{url}\" target=\"_blank\">点击此处</a>。",
    "Info": "信息",
    "Open": "打开",
